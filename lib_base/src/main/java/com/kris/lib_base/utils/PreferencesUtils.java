...
public class PreferencesUtils {
	 ...
	 *         is not a string
	 */
	public static String getAppString(Context context, String key, String defaultValue) {
		if (context == null) {
			return "";
		}
	...
	public static String getUserString(Context context, String key, String defaultValue) {
		if (context == null) {
			return "";
		}
